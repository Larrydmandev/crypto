            ...
            <div className="row" style={{marginBottom: '5%'}}>
                ...
                <div className="col-4">
                  <Link to="/Bitcoin" style={{textDecoration: 'none', color:'black'}}>
                      <div className="card" style={{width: '9rem', height: '9rem' , position: 'relative', left:'170%'}}>
                ...
                <div className="col-4">
                   <Link to="/Ethereum" style={{textDecoration: 'none', color: 'black'}}>
                        <div className="card" style={{width: '9rem', height: '9rem' , position: 'relative', left:'110%'}}>
                            <div className="card-body">
                                <div style={{marginBottom: '5%'}}>
                ...
                <div className="col-4">
                   <Link to="/Tether" style={{textDecoration: 'none', color:'black'}}>
                        <div className="card" style={{width: '9rem', height: '9rem' , position: 'relative', left:'50%'}}>
                            <div className="card-body">
                                <div style={{marginBottom: '5%'}}>
